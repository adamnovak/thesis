...
The first piece of preliminary work presented here is the UCSC Tumor Map, visible in Figure \ref{fig:tumormap}.

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/tumormap.png}
    \caption{A screenshot of the UCSC Tumor Map. Individual tumor samples are represented by cells in a hexagonal grid, laid out using a spring layout algorithm based on molecular similarity. Hexes can be colored using various data overlays, and statistical queries can be run interactively.}
    \label{fig:tumormap}
\end{figure}
