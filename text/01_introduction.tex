...
The human body is the product of a four-billion-year-old pileing-up of nanotechnological hacks, which exists because, for that four billion years, none of its ancestors died without issue; we have hijacked it and are now attempting to use it to carry us around while we compose symphonies, build telescopes, write Ph.D. theses, and generally attempt to be people as opposed to just humans. We don't really know how it works, we don't have access to the proper servicing equipment to fix it properly when it breaks, and the thing just wans't really meant to do what we're trying to do with it. The goal of human genomics is to figure out how these things we call our bodies actually work, so that we can do more than just change the nanotechnological oil and hope for the best.

% This problem is hard because of the scale of the thing

% And it's compounded by the fundamental not-designed-ness of the thing
    % It's not a problem in the class of problems that our minds are the right shape to solve, really.

% So we need to integrate basically everything we've got...


% The science of human genomics consists, roughly, of writing the service manual for a nuclear aircraft carrier while using it to fight a war. Only the aircraft carrier was designed by aliens with no sense of elegance.

%In her paper, \textit{Is Having Children Always Wrong?}, Professor Rivka Weinberg reluctantly concludes that it is not necessarily always wrong to cause people to exist. 

%To be human is to fall heir to a human genome: six billion letters of genetic code, the latest results of a four-billion-year winnowing process that has killed most things that have ever lived. 
...
% Something cooler than the scale intro because it turns out I have to graduate and I still have no scale

% Ditch all this scale stuff and talk about things I actually did and give sort of a document map and tie it together.
