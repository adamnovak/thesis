...
based on the Samtools pileup approach \cite{li2009sequence}, modified to work
...
Samtools \cite{li2009sequence} were run on BWA-MEM \cite{li2009fast}
...
Samtools \cite{li2009sequence}. The process took advantage of the tool's
ability to subset indexed files over FTP in order to obtain just reads
mapped within the region \cite{li2009sequence}. Next, the alignments were
