...
reference genome \cite{Horton2008-qt,Pei2012-xo}. Furthermore, as a
...
\cite{Dilthey2015-cn,Paten2014-ga,Maciuca2016-ol}, and work has been
...
\begin{table}
  ...
  \\
  \hline
  Cactus & UCSC & Cactus & Graph-based multiple sequence aligner \cite{Paten2011-lh}.
  \\
  Camel & UCSC & Camel & Creates graphs progressively by mapping using
  context schemes \cite{Novak2015-rw}.
  \\
  ...
  K-mer-based HMM description of a region \cite{Dilthey2015-cn}.
  \\
...
polymorphism \cite{Brandt2015-og}. Similar, slightly smaller increases
...
Freebayes \cite{Garrison2012-gr}, Platypus \cite{Rimmer2014-zj} and
...
graph\cite{Novak2016-ek}, making it a \emph{variation graph}. This would
